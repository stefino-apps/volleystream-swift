...
struct RemoteMatchState: Codable {
    ...
    func toDictionary() -> [String: Any] {
        return [
            ...
            "fullScreenSponsor": fullScreenSponsor,
            "servingTeam": servingTeam,
            "dataUsageGB": dataUsageGB,
            "batteryLevel": batteryLevel,
            "languageCode": languageCode,
            "soccerHalfDuration": soccerHalfDuration,
            "timerSeconds": timerSeconds,
            "timerRunning": timerRunning,
            "timerStartTime": timerStartTime,
            "redCardsA": redCardsA,
            "redCardsB": redCardsB,
            "isGoalAlertActive": isGoalAlertActive,
            "goalAlertTeam": goalAlertTeam,
            "goalAlertStartTime": goalAlertStartTime,
            "tennisPointsA": tennisPointsA,
            "tennisPointsB": tennisPointsB,
            "tennisGamesA": tennisGamesA,
            "tennisGamesB": tennisGamesB,
            "isTiebreak": isTiebreak,
            "isPuntoDeOro": isPuntoDeOro,
            "dartsMode": dartsMode,
            "dartsActivePlayer": dartsActivePlayer,
            "dartsLegsA": dartsLegsA,
            "dartsLegsB": dartsLegsB,
            "dartsThrows": dartsThrows,
            "dartsTurnScore": dartsTurnScore,
            "isDartsBust": isDartsBust,
            "cricketBallsA": cricketBallsA,
            "cricketBallsB": cricketBallsB,
            "cricketWicketsA": cricketWicketsA,
            "cricketWicketsB": cricketWicketsB,
